...
class TrendRecommendWriteBody1 extends Component {
  state = {
    title: '',
    contents: '',
  }
  ...
  render() {
    const { contents, title } = this.props.TrendRecommendWriteBody1
    return (
          ...
          <View style={styles.contents}>
            {
              <View style={styles.textArea}>
                <TextInput
                  ...
                  onChangeText={(title) => this.props.onChange('TrendRecommendWriteBody1', 'title', title)}
                />
          ...
          <View style={styles.contents}>
            <View style={styles.textAreaContents}>
              <TextInput
                ...
                onChangeText={(contents) => this.props.onChange('TrendRecommendWriteBody1', 'contents', contents)}
...
export default connect(mapStateToProps)(TrendRecommendWriteBody1)
